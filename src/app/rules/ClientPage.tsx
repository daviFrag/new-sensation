...
export function RulesLoaded(props: {
  ...
  const { rules, vocabularies, blocks, vocabularies_metadata, reloadRules, access_token } =
    props;
  ...
  return (
    <main>
            ...
            >
              <div className=" flex justify-between">
                ...
                <div className="w-1/12 flex">
                  ...
                  <div
                    onClick={() => {
                      deleteRuleApi(r, access_token, reloadRules);
                    }}
                    className="cursor-pointer duration-75 ease-in-out hover:scale-110"
                  >
                    <Bin />
      ...
      <CreateGameModal modal={modal} rules_ids={selected_rules_ids} access_token={access_token} />
    </main>
  );
}
...
function RulesPartial(props: {
    ...
    const { vocabularies_metadata, vocabularies, blocks, access_token } = props;
    const {
      data: rules,
      is_loading,
      is_error,
      invalidateQuery,
    } = useRulesApiQuery(vocabularies_metadata, access_token);
...
export default function ClientPage({access_token}: {access_token?: string}) {
