...
function GamesPartial(props: {
    ...
    const { vocabularies_metadata, vocabularies, access_token } = props;
    const {
      data: rules,
...
function GamesLoaded(props: {
  ...
  const { vocabularies, rules, tasks, vocabularies_metadata, reloadData, access_token } =
    props;
